...
var GooogleSpreadsheet = function( ss_key, auth_id, options ){
  ...
  // public API methods
  this.addSpreadSheet = function( title, cb ) {
	  var data_xml = '<entry xmlns="http://www.w3.org/2005/Atom" xmlns:gsx="http://schemas.google.com/spreadsheets/2006">' + "\n";
	  data_xml += "<title>" + title + "</title>" + "\n";
	  data_xml += "<gsx:rowCount>1000</gsx:rowCount>" + "\n";
	  data_xml += "<gsx:colCount>26</gsx:colCount>" + "\n";
	  data_xml += '</entry>';
	  self.makeFeedRequest(["worksheets", ss_key], 'POST', data_xml, function(err, data, xml) {
		  ...
		  data.link.forEach(function(link) {
			  var obj = link.$;
			  if(obj.rel.match("#visualizationApi")) {
				  var link = obj.href;
				  id = link.split("?gid=")[1];
			  }
		  });
